...
public class FdaEnricher implements AggregationStrategy {
    ...
    public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
        ...
        if (newExchange.getIn().getHeader(Exchange.HTTP_RESPONSE_CODE, Integer.class) == 200) {
            ...
            drugStore.setGenericName(newExchange.getIn().getHeader("packageDescription",String.class));
            drugStore.setLabelerName(newExchange.getIn().getHeader("packageDescription",String.class));
